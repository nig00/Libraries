...
#define SPI_SPEED   100000  // !! Starts low here and if all works try to increase if needed on a breadboard I could go upto about 750000 
/////////////////////     READ ADC VALUES  ///////////////////////////////////
...
usleep(600000);usleep(600000);usleep(600000);
lcdPosition(lcd,0,1);           //Position cursor on the first line in the first column
lcdPuts(lcd, "GPRS MODEM");  //Print the text on the LCD at the current cursor postion
usleep(600000);usleep(600000);usleep(600000);
lcdClear(lcd);
...
lcdPosition(lcd,0,0);          
lcdPuts(lcd, "gprs START..."); 
write(fd,"AT\r\n",4);usleep(600000);usleep(600000);usleep(600000);
write(fd,"AT\r\n",4);usleep(600000);usleep(600000);usleep(600000);
write(fd,"AT\r\n",4);usleep(600000);usleep(600000);usleep(600000);
write(fd,"AT+CMGF=1\r\n",11);usleep(600000);usleep(600000);usleep(600000);
write(fd,"AT+CMGF=1\r\n",11);usleep(600000);usleep(600000);usleep(600000);
write(fd,"AT+CGATT=1\r\n",12);usleep(600000);usleep(600000);usleep(600000);
write(fd,"AT+SAPBR=3,1,\"CONTYPE\",\"GPRS\"\r\n",31);usleep(600000);usleep(600000);usleep(600000);
write(fd,"AT+SAPBR=3,1,\"APN\",\"internet\"\r\n",31);usleep(600000);usleep(600000);usleep(600000);
write(fd,"AT+SAPBR=1,1\r\n",14);usleep(600000);usleep(600000);usleep(600000);usleep(600000);usleep(600000);usleep(600000);
write(fd,"AT\r\n",4);usleep(600000);usleep(600000);usleep(600000);
lcdPosition(lcd,0,0);           
lcdPuts(lcd, "HTTP START..."); 
write(fd,"AT+HTTPINIT\r\n",13);usleep(600000);usleep(600000);usleep(600000);
write(fd,"AT+HTTPPARA=\"CID\",1\r\n",21);usleep(600000);usleep(600000);usleep(600000);
while(1)
{
a=a+1;jj=0;
lcdClear(lcd);  
...
usleep(600000);
write(fd,"AT+HTTPPARA=\"URL\",\"http://www.b4d.in/monitor/put_data.php",57);
write(fd,"?ecgx=",6);usleep(600000);usleep(30000);
...
write(fd,"&hbet=",6);usleep(600000);usleep(30000);
...
write(fd,"\"",1);usleep(30000);usleep(30000);usleep(30000);
write(fd,"\r\n",2);usleep(30000);
write(fd,"AT+HTTPACTION=0\r\n",17);
usleep(600000);usleep(600000);
lcdClear(lcd);
lcdPosition(lcd,0,0);          
lcdPuts(lcd, "GPRS SENT...."); 
usleep(60000);
usleep(60000);
lcdClear(lcd);
lcdPosition(lcd,0,0);          
lcdPuts(lcd, "GPRS CLOSE...."); 
a=0;
}
usleep(100000);
}
